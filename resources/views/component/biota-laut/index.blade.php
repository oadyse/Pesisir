                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">Data Golongan Parameter Biota Laut</h4>
                            </div>
                            ...
                            {{-- Modal Create --}}
                            @include('component.biota-laut.create')
                                ...
                                <table id="datatable-1" class="table data-table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($data as $parameter) {
                                            $id = $parameter->id;
                                            if ($parameter->jenis == "biota") {
                                        ?>
                                        <tr>
                                            <td width="5%">{{ $no }}</td>
                                            <td>{{ $parameter->gol_parameter->nama }}</td>
                                            <td>{{ $parameter->parameter }} {{ $parameter->nama_lain }}</td>
                                            <td>
                                                ...
                                                <a class="iq-icons-list m-0 text-danger"
                                                    href="{{ route('delete-biota', base64_encode($id)) }}"
                                                    title="Delete">
                                                ...
                                                {{-- Modal Edit --}}
                                                @include('component.biota-laut.edit')
                                            </td>
                                        </tr>
                                        <?php
                                        $no += 1;
